...
> Version 2.5.9 · A single-file household budget planner. No server, no install, no dependencies.
...
- [Notifications](https://github.com/lancebramsay/hedgie/wiki/Notifications)
